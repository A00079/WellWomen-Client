...
const TrialBlog = () => {
    ...
    return (
        <React.Fragment>
            <h3 style={{ fontFamily: 'Paytone One' }} class="text-3xl sm:text-5xl md:text-4xl md:mt-32 leading-normal font-extrabold tracking-tight text-gray-900 text-center mb-0 mt-40 sm:mb-10">
