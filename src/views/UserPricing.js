    ...
    return (
        <React.Fragment>
            ...
            <section class="text-gray-700 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 xl:w-1/4 md:w-1/2 w-full cursor-pointer" onClick={() => handelActivePlan('free')}>
                            <div
                                className={activePlan === 'free' ? 'h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden' : 'h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden'}
                            >
            ...
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                        ...
                        <div class="p-4 xl:w-1/4 md:w-1/2 w-full cursor-pointer" onClick={() => handelActivePlan('popular')}>
                            <div
          ...
          <a href='https://www.instamojo.com/wellwomanclinic/'>
            ...
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                        ...
                        <div class="p-4 xl:w-1/4 md:w-1/2 w-full cursor-pointer" onClick={() => handelActivePlan('BUSINESS')}>
                            <div
                                className={activePlan === 'BUSINESS' ? 'h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden' : 'h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden'}
                            >
          ...
          <a href='https://www.instamojo.com/wellwomanclinic/'>
            ...
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                        ...
                        {/* <div class="p-4 xl:w-1/4 md:w-1/2 w-full cursor-pointer" onClick={() => handelActivePlan('SPECIAL')}>
                            ...
                            >
                                <span class="bg-indigo-500 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">Special</span>
