...
class CardCarousel extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <div className="mt-40">
          <h1 class="sm:text-3xl  text-2xl font-medium title-font text-gray-900" align="center">OUR WORK</h1>
          <div>
            <AutoplaySlider
              organicArrows={true}
              ...
              <div className='screenheight'>
                <div className="max-w-md md:max-w-5xl">
                  <div className="bg-white shadow-xl rounded-lg overflow-hidden md:flex">
                    <div className="bg-cover bg-bottom h-56 md:h-auto md:w-56" style={{width: '45rem', backgroundImage: 'url(https://images.unsplash.com/photo-1517736996303-4eec4a66bb17?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1268&q=80)' }}>
                    </div>
                    <div>
                      ...
                      <div className="p-4 md:p-5 bg-gray-100">
                        ...
                        <div className="mt-3 text-gray-600 text-sm md:text-base">“Health is a state of complete harmony of the body, mind and spirit."</div>
                      </div>
                    </div>
                  </div>
                </div>
