...
class CardCarousel extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <h1 className="ribbon">
          <strong className="ribbon-content">Our Work</strong>
        </h1>
                    ...
                    <div>
                      ...
                      <div className="p-4 md:p-5 bg-gray-100">
                        <div className="sm:flex sm:justify-between sm:items-center">
                          <div>
                            <div className="text-lg text-gray-700"><span className="text-gray-900 font-bold"><img src={feedback} style={{    display: 'inline-block',
    width: '24px'}} /></span>Feed Backs*</div>
