                        ...
                        <div class="container px-5 py-4 mx-auto">
                            ...
                            <div class="flex flex-wrap -m-4 text-center">
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-2 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
                                            <path d="M8 17l4 4 4-4m-4-5v9"></path>
                                            <path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29"></path>
                                        </svg>
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='14578' /></h2>
                                ...
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-2 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='113690' /></h2>
                                ...
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-2 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='1208' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#D00F7F' }}>Reviews</p>
                                    </div>
                                </div>
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-0 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-indigo-500 w-12 h-12 mb-3 inline-block">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <h2 class="title-font font-medium text-3xl" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='51' /></h2>
