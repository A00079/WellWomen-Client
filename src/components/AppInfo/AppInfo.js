        ...
        return (
            <React.Fragment>
                        ...
                        <div className="flex flex-wrap -m-4 text-center">
                            <div className="p-4 md:w-1/1 sm:w-1/2 w-full">
                                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                    ...
                                    <img src={downloads} className="text-yellow-500 w-12 h-12 mb-3 inline-block" />
                ...
                <div class="py-6 md:py-8 mt-16" id='stats'>
                    ...
                    <section class="text-gray-700 pt-10 pb-10 body-font" style={{background: '#D00F7F'}}>
                        <div class="container px-5 py-4 mx-auto">

                            <div class="flex flex-wrap -m-4 text-center">
                                <div class="p-1 lg:p-4 md:p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #FFF' }} class="px-0 lg:px-2 md:px-2 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-2xl text-gray-900" style={{ color: '#FFF', fontFamily: 'Open Sans' }}><ReRender countNo='14578' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#FFF' }}>Total Clients</p>
                                    </div>
                                </div>
                                <div class="p-1 lg:p-4 md:p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #FFF' }} class="px-0 lg:px-2 md:px-2 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="text-yellow-500 w-12 h-12 mb-3 inline-block">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                                        </svg>
                                        <h2 class="title-font font-medium text-2xl text-gray-900" style={{ color: '#FFF', fontFamily: 'Open Sans' }}><ReRender countNo='113690' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#FFF' }}>Total Weight Loss</p>
                                    </div>
                                </div>
                                <div class="p-1 lg:p-4 md:p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #FFF' }} class="px-0 lg:px-2 md:px-2 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-2xl" style={{ color: '#FFF', fontFamily: 'Open Sans' }}><ReRender countNo='1208' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#FFF' }}>Reviews</p>
                                    </div>
                                </div>
                                <div class="p-1 lg:p-4 md:p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #FFF' }} class="px-0 lg:px-2 md:px-2 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-2xl" style={{ color: '#FFF', fontFamily: 'Open Sans' }}><ReRender countNo='51' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#FFF' }}>Countries reached</p>
                                    </div>
                                </div>
                            </div>
                        </div>
