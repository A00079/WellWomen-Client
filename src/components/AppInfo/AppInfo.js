                            ...
                            <div class="flex flex-wrap -m-4 text-center">
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{border: '2px solid #D00F7F'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{color: '#000',fontFamily: 'Open Sans'}}>2.7K</h2>
                                ...
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{border: '2px solid #D00F7F'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{color: '#000',fontFamily: 'Open Sans'}}>1.3K</h2>
                                ...
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{border: '2px solid #D00F7F'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl" style={{color: '#000',fontFamily: 'Open Sans'}}>74</h2>
                                ...
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{border: '2px solid #D00F7F'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl" style={{color: '#000',fontFamily: 'Open Sans'}}>46</h2>
