    ...
    render() {
        return (
            <React.Fragment>
                ...
                <div class="py-24 md:py-8" style={{background: 'linear-gradient(to right, #ffe000, #799f0c)'}}>
                        ...
                        <div class="container px-5 py-4 mx-auto">
                            ...
                            <div class="flex flex-wrap -m-4 text-center">
                                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                    <div style={{border: '2px solid #283481'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
                                            <path d="M8 17l4 4 4-4m-4-5v9"></path>
                                            <path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29"></path>
                                        </svg>
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{color: '#283481'}}>2.7K</h2>
                                ...
                                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                    <div style={{border: '2px solid #283481'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{color: '#283481'}}>1.3K</h2>
                                        <p class="leading-relaxed text-white">Awards</p>
                                    </div>
                                </div>
                                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                    <div style={{border: '2px solid #283481'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl" style={{color: '#283481'}}>74</h2>
                                        <p class="leading-relaxed text-white">Likes</p>
                                    </div>
                                </div>
                                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                    <div style={{border: '2px solid #283481'}} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl" style={{color: '#283481'}}>46</h2>
                                        <p class="leading-relaxed text-white">Recomended</p>
                                    </div>
                                </div>
                            </div>
                        </div>
