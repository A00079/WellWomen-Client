    ...
    render() {
        return (
            <React.Fragment>
                ...
                <div class="py-24 md:py-8" id='stats'>
                    ...
                    <section class="text-gray-700 pb-10 body-font">
                        <div class="container px-5 py-4 mx-auto">
                            ...
                            <div class="flex flex-wrap -m-4 text-center">
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
                                            <path d="M8 17l4 4 4-4m-4-5v9"></path>
                                            <path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29"></path>
                                        </svg>
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='2700' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#D00F7F' }}>Downloads</p>
                                    </div>
                                </div>
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl text-gray-900" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='1300' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#D00F7F' }}>Awards</p>
                                    </div>
                                </div>
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='74' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#D00F7F' }}>Likes</p>
                                    </div>
                                </div>
                                <div class="p-4 w-1/2 md:w-1/4 sm:w-1/2">
                                    <div style={{ border: '2px solid #D00F7F' }} class="px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <h2 class="title-font font-medium text-3xl" style={{ color: '#000', fontFamily: 'Open Sans' }}><ReRender countNo='46' /></h2>
                                        <p class="leading-relaxed font-black" style={{ fontFamily: 'Open Sans', color: '#D00F7F' }}>Recomended</p>
                                    </div>
                                </div>
                            </div>
                        </div>
