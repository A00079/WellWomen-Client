...
class About extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <h1 id="aboutus" style={{ color: '#4e6073', textAlign: 'center' }} className="sm:text-3xl text-3xl mt-24  md:text-4xl md:mt-24 font-medium title-font mb-4 font-extrabold text-gray-900">ABOUT   <span class="text-indigo-600">US</span></h1>
                <section className="text-gray-700 body-font" style={{background: 'rgb(249, 174, 8)'}}>
