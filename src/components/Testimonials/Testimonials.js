...
class Testimonial extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <h1 className="sm:text-3xl  text-2xl font-medium title-font mb-4 text-gray-900" align="center">WHAT OUR CUSTOMERS SAYS</h1>
                <div style={Testimonial.CONTAINER_STYLE}>
