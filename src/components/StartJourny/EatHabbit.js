    ...
    render() {
        return (
            <React.Fragment>
                ...
                WHAT  <span class="text-indigo-600"> ARE YOUR CURRENT EATING HABITS ?</span>
                </h3>
                        ...
                        <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                            <div class="p-2 sm:w-1/2 w-full cursor-pointer" onClick={() =>this.handelEatHabbit("It's total chaos. I eat whatever I want & whatever is put in front of me")}>
                                <div class="bg-gray-200 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium">It's total chaos. I eat whatever I want & whatever is put in front of me</span>
                                </div>
                            </div>
                            <div class="p-2 sm:w-1/2 w-full cursor-pointer" onClick={() =>this.handelEatHabbit("I try to watch what I eat sometimes but sometimes feel guilty and too full")}>
                                <div class="bg-gray-200 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium">I try to watch what I eat sometimes but sometimes feel guilty and too full</span>
                                </div>
                            </div>
                            <div class="p-2 sm:w-1/2 w-full cursor-pointer" onClick={() =>this.handelEatHabbit("I don't watch what I eat but I control my portion sizes")}>
                                <div class="bg-gray-200 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium">I don't watch what I eat but I control my portion sizes</span>
                                </div>
                            </div>
                            <div class="p-2 sm:w-1/2 w-full cursor-pointer" onClick={() =>this.handelEatHabbit("I eat healthy food in measured portion sizes")}>
                                <div class="bg-gray-200 rounded flex p-4 h-full items-center">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" class="text-indigo-500 w-6 h-6 flex-shrink-0 mr-4" viewBox="0 0 24 24">
                                        <path d="M22 11.08V12a10 10 0 11-5.93-9.14"></path>
                                        <path d="M22 4L12 14.01l-3-3"></path>
                                    </svg>
                                    <span class="title-font font-medium">I eat healthy food in measured portion sizes</span>
                                </div>
                            </div>
                        </div>
                    </div>
